...
const Intro = () => {
  return (
    <div>
      ...
      >
        <h1 className="mx-4 md:mx-32 sm:mx-22 text-2xl md:text-5xl lg:text-5xl xl:text-5xl">
          Making Health
        </h1>
        <h1 className="mx-4 sm:mx-22 md:mx-32 text-2xl md:text-4xl lg:text-5xl xl:text-5xl pb-1">
          Care Better Together
        </h1>
        <p className="mx-4 md:mx-32 sm:mx-22 text-lg md:text-2xl lg:text-3xl font-bold">
